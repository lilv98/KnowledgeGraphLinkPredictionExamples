...
class Runner(object):
    def __init__(self, params):
        ...
        self.train_data = pd.read_csv(data_root + 'train.txt', delimiter='\t', header=None)
        self.valid_data = pd.read_csv(data_root + 'valid.txt', delimiter='\t', header=None)
        self.test_data = pd.read_csv(data_root + 'test.txt', delimiter='\t', header=None)
        self.nodes = list(set(self.train_data[0].unique()) | set(self.train_data[2].unique()) | set(self.valid_data[0].unique()) | set(self.valid_data[2].unique()) | set(self.test_data[0].unique()) | set(self.test_data[2].unique()))
        self.rels = list(set(self.train_data[1].unique()) | set(self.valid_data[1].unique()) | set(self.test_data[1].unique()))
        ...
        self.valid_data[0], self.valid_data[1], self.valid_data[2] = self.valid_data[0].map(nodes_dict), self.valid_data[1].map(rels_dict), self.valid_data[2].map(nodes_dict)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filtered", dest='filtered', 
                        action='store_true')
    parser.add_argument("--raw", dest='filtered', 
                        action='store_false')
